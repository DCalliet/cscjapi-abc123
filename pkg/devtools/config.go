...
func LoadConfig() (v *viper.Viper, err error) {
	...
	v.BindEnv("WORKER_POLLING_WAIT_IN_SECONDS")
	...
	v.SetDefault("WORKER_POLLING_WAIT_IN_SECONDS", 10)
...
type ApplicationConfig struct {
	...
	EnvWorkerPollingWaitInSeconds int    `json:"WORKER_POLLING_WAIT_IN_SECONDS" mapstructure:"WORKER_POLLING_WAIT_IN_SECONDS"`
}
